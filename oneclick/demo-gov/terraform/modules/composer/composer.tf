  ...
  config {
    ...
    software_config {
      ...
      env_variables = {
        ...
        AIRFLOW_VAR_CUSTOMER_DC_INFO_INPUT_PATH = "${var.dataplex_process_bucket_name}/customer-source-configs",
        ...
        AIRFLOW_VAR_CUSTOMER_DP_INFO_INPUT_PATH = "${var.dataplex_process_bucket_name}/customer-source-configs",
        ...
        AIRFLOW_VAR_CUSTOMER_DQ_INFO_INPUT_PATH = "${var.dataplex_process_bucket_name}/customer-source-configs",
        AIRFLOW_VAR_CUSTOMER_DQ_INPUT_FILE = "data-product-quality-tag-auto.yaml",
        AIRFLOW_VAR_CUSTOMER_DQ_RAW_INPUT_YAML = "${var.dataplex_process_bucket_name}/customer-source-configs/dq_customer_gcs_data.yaml",
        AIRFLOW_VAR_CUSTOMER_DX_INFO_INPUT_PATH = "${var.dataplex_process_bucket_name}/customer-source-configs",
        ...
        AIRFLOW_VAR_GCP_SUB_NET = "projects/${var.project_id}/regions/${var.location}/subnetworks/${var.prefix}-misc-subnet",
        ...
        AIRFLOW_VAR_GDC_TAG_JAR = "${var.dataplex_process_bucket_name}/common/tagmanager-1.0-SNAPSHOT.jar",
        AIRFLOW_VAR_INPUT_TBL_CC_CUST = "cc_customers_data",
        AIRFLOW_VAR_INPUT_TBL_CUST = "customers_data",
        AIRFLOW_VAR_MERCHANT_DC_INFO_INPUT_PATH = "${var.dataplex_process_bucket_name}/merchant-source-configs/",
        ...
        AIRFLOW_VAR_MERCHANT_DP_INFO_INPUT_PATH = "${var.dataplex_process_bucket_name}/merchant-source-configs",
        ...
        AIRFLOW_VAR_MERCHANT_DQ_INFO_INPUT_PATH = "${var.dataplex_process_bucket_name}/merchant-source-configs",
        AIRFLOW_VAR_MERCHANT_DQ_INPUT_FILE = "data-product-quality-tag-auto.yaml",
        AIRFLOW_VAR_MERCHANT_DQ_RAW_INPUT_YAML = "${var.dataplex_process_bucket_name}/merchant-source-configs/dq_merchant_gcs_data.yaml",
        AIRFLOW_VAR_MERCHANT_DX_INPUT_FILE = "data-product-exchange-tag-manual.yaml",
        AIRFLOW_VAR_MERCHANT_DX_INPUT_PATH = "${var.dataplex_process_bucket_name}/merchant-source-configs",
        ...
        AIRFLOW_VAR_TRANSACTIONS_DP_INFO_INPUT_PATH = "${var.dataplex_process_bucket_name}/transactions-source-configs",
        ...
        AIRFLOW_VAR_TRANSACTIONS_DQ_INFO_INPUT_PATH = "${var.dataplex_process_bucket_name}/transactions-source-configs",
        AIRFLOW_VAR_TRANSACTIONS_DQ_INPUT_FILE = "data-product-quality-tag-auto.yaml",
        AIRFLOW_VAR_TRANSACTIONS_DQ_RAW_INPUT_YAML = "${var.dataplex_process_bucket_name}/transactions-source-configs/dq_transactions_gcs_data.yaml",
        AIRFLOW_VAR_TRANSACTIONS_DX_INFO_INPUT_PATH = "${var.dataplex_process_bucket_name}/transactions-source-configs",
        AIRFLOW_VAR_TRANSACTIONS_DX_INPUT_FILE = "data-product-exchange-tag-manual.yaml",
        AIRFLOW_VAR_TRANSACTIONS_DX_INPUT_PATH = "${var.dataplex_process_bucket_name}/transactions-source-configs/",
