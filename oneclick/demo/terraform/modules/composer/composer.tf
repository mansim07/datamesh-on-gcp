  ...
  config {
    ...
    software_config {
      ...
      env_variables = {
        ...
        customer_dc_info_input_path = "gs://${var.prefix}-datagovernance-process/customer-source-configs",
        ...
        customer_dp_info_input_path = "gs://${var.prefix}-datagovernance-process/customer-source-configs",
        ...
        customer_dq_info_input_path = "gs://${var.prefix}-datagovernance-process/customer-source-configs",
        customer_dq_input_file = "data-product-quality-tag-auto.yaml",
        customer_dq_raw_input_yaml = "gs://${var.prefix}-datagovernance-process/customer-source-configs/dq_customer_gcs_data.yaml",
        customer_dx_info_input_path = "gs://${var.prefix}-datagovernance-process/customer-source-configs",
        ...
        gdc_tag_jar = "gs://${var.prefix}-datagovernance-process/common/tagmanager-1.0-SNAPSHOT.jar",
        input_tbl_cc_cust = "cc_customers_data",
        input_tbl_cust = "customers_data",
        merchant_dc_info_input_path = "gs://${var.prefix}-datagovernance-process/merchant-source-configs/",
        ...
        merchant_dp_info_input_path = "gs://${var.prefix}-datagovernance-process/merchant-source-configs",
        ...
        merchant_dq_info_input_path = "gs://${var.prefix}-datagovernance-process/merchant-source-configs",
        merchant_dq_input_file = "data-product-quality-tag-auto.yaml",
        merchant_dq_raw_input_yaml = "gs://${var.prefix}-datagovernance-process/merchant-source-configs/dq_merchant_gcs_data.yaml",
        merchant_dx_input_file = "data-product-exchange-tag-manual.yaml",
        merchant_dx_input_path = "gs://${var.prefix}-datagovernance-process/merchant-source-configs",
        ...
        transactions_dp_info_input_path = "gs://${var.prefix}-datagovernance-process/transactions-source-configs",
        ...
        transactions_dq_info_input_path = "gs://${var.prefix}-datagovernance-process/transactions-source-configs",
        transactions_dq_input_file = "data-product-quality-tag-auto.yaml",
        transactions_dq_raw_input_yaml = "gs://${var.prefix}-datagovernance-process/transactions-source-configs/dq_transactions_gcs_data.yaml",
        transactions_dx_info_input_path = "gs://${var.prefix}-datagovernance-process/transactions-source-configs",
        transactions_dx_input_file = "data-product-exchange-tag-manual.yaml",
        transactions_dx_input_path = "gs://${var.prefix}-datagovernance-process/transactions-source-configs/",
